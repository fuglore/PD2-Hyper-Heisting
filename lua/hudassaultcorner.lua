...
Hooks:PostHook(HUDAssaultCorner, "_get_assault_strings", "post_FG", function(self)
	...
	local FG_chance = math.random(1, 293)
	local danger_chance = math.random(1, 49)
	local heat_chance = math.random(1, 30)
