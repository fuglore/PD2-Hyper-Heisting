...
Hooks:PostHook(HUDAssaultCorner, "_get_assault_strings", "post_FG", function(self)
	...
	local FG_chance = math.random(1, 263)
	local danger_chance = math.random(1, 118)
	local heat_chance = math.random(1, 115)
