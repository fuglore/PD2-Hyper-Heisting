Hooks:Add("LocalizationManagerPostInit", "shin_loc", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["hud_assault_FG_cover92"] = "EYE TO EYE, DON'T BE FAKE",
		...
		["loading_hh_13"] = "In Hyper Heisting, Heavy SWATs, Maximum Force Responders, and ZEAL Heavy SWATs gain protection from bullet-based instant kills on Death Sentence! But only from weapons and ammo types that can't shoot through walls!",
...
Hooks:Add("LocalizationManagerPostInit", "HH_overhaul", function(loc)
	...
	if PD2THHSHIN and PD2THHSHIN:IsOverhaulEnabled() then
		LocalizationManager:add_localized_strings({		
			...
			["menu_sniper_graze_damage_desc"] = "BASIC: ##$basic##\nSuccessfully killing an enemy with a headshot will cause a ##massive blood explosion## that ##staggers## enemies within a ##4m## radius of the victim.\n\nThis can only be activated by weapons fired in their ##single-fire## mode.\n\nACE: ##$pro##\nFine Red Mist's blood explosion now ##deals 400 damage##.\n\n##Thanks for standing still, wanker!##",
