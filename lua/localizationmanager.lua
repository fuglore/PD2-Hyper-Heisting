Hooks:Add("LocalizationManagerPostInit", "shin_assaultcornertext", function(loc)
	LocalizationManager:add_localized_strings({
		...
		["loading_heister_44"] = "Mayhem and Death Wish enemies are much better at dodging! Try to predict when they will execute them!",
		...
		["loading_heister_51"] = "Having a generalist perkdeck that can do a lot of things is completely ok...Assuming you have the skill to back it up!",
		...
		["loading_hh_5"] = "ZEAL Cloakers are sneaky, listen out for their gasmask breathing, it's your only way to tell you're getting charged!",
		["loading_hh_6"] = "Special enemies get more dangerous as difficulties increase! Keep a close eye on them!",
		["loading_hh_7"] = "Join the Hyper Heisting Discord! You can find a link to it in the ModWorkshop page!",
	})
end)
