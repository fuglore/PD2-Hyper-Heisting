...
function BlackMarketGui:update_info_text()
	...
	elseif identifier == self.identifiers.grenade then
		...
		updated_texts[4].resource_color = {}
		local desc_text = managers.localization:text(grenade_tweak.desc_id)
		
		if grenade_tweak.base_cooldown then
			desc_text = desc_text .. "\n\nBase Cooldown: " .. tostring(grenade_tweak.base_cooldown) .. "s \n"
		elseif grenade_tweak.pickup_chance then
			local pickup_chance = grenade_tweak.pickup_chance * 100
