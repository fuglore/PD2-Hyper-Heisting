...
function CopActionWalk:init(action_desc, common_data)
	...
	self._is_cop = common_data.ext_base.has_tag and common_data.ext_base:has_tag("law") 
...
function CopActionWalk:on_exit()
	...
	if not self._common_data.ext_damage:dead() and self._ext_base.has_tag and self._ext_base:has_tag("spooc") then
