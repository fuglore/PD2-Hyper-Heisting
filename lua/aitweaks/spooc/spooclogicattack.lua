...
function SpoocLogicAttack._upd_spooc_attack(data, my_data)
	...
	if focus_enemy and focus_enemy.nav_tracker and focus_enemy.is_person and REACT_SHOOT <= focus_enemy.reaction and not data.unit:movement():chk_action_forbidden("walk") then
