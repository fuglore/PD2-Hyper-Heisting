...
function CopBrain:update(unit, t, dt)
	...
	if logic.update then
		...
		logic.update(l_data)
		self._logic_data.needs_immediate_update = nil
	end
	
	self._current_logic_needs_immediate_update = nil
end
...
function CopBrain:set_init_logic(name, enter_params)
	...
	l_data.name = name
	l_data.logic = logic
	l_data.needs_immediate_update = true
	self._current_logic = logic
	self._current_logic_name = name
	self._current_logic_needs_immediate_update = true
