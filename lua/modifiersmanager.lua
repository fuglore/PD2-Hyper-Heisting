...
if level == "spa" or level == "glace" or level == "brb" or level == "red2" or level == "run" or level == "flat" or level == "flat_hh" or level == "dinner" or level == "no_mercy_hypered" then
	replacement_table = {
...
elseif _G.BB or FullSpeedSwarm or Iter or _G.SC or _G.deathvox or PD2THHSHIN and PD2THHSHIN:IsAlbanianContentEnabled() then
	replacement_table = {
